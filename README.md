...
- **[Pulse-1.0.1-arm64.dmg](https://github.com/miftahganzz/Pulse/releases/latest/download/Pulse-1.0.1-arm64.dmg)** — Apple Silicon Macs (M1 / M2 / M3 / M4)
- **[Pulse-1.0.1-x86_64.dmg](https://github.com/miftahganzz/Pulse/releases/latest/download/Pulse-1.0.1-x86_64.dmg)** — Intel 64-bit Macs
- **[Pulse-1.0.1-Universal.dmg](https://github.com/miftahganzz/Pulse/releases/latest/download/Pulse-1.0.1-Universal.dmg)** — Universal 2 (runs on all Macs)
- **[Pulse-1.0.1.dmg](https://github.com/miftahganzz/Pulse/releases/latest/download/Pulse-1.0.1.dmg)** — Default Universal installer
...
```text
Pulse Agent System Doctor (v1.0.1)

 [✔] Pulse Agent Version        : v1.0.1
